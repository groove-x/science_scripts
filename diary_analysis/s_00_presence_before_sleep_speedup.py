...
diary_csv_path = './00_base_data_diary/presence/'  # 相対パスを指定
out_folder = "./s_00_presence_sleep_wake/"
...
df_ex_data.to_csv("./{}/presence_sleep_1hr.csv".format(out_folder), index=False)  # index=False により、インデックスはCSVに含まれない
...
df_ex_data.to_csv("./{}/presence_wake_1hr.csv".format(out_folder), index=False)  # index=False により、インデックスはCSVに含まれない
