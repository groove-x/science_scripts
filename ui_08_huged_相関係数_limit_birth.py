...
class AnalysisApp:
    ...
    def run_analysis(self):
        ...
        for csv_file in diary_csv_files:
            ...
            #-----------
            # 欠損値を無視する
            df_data = df_data.dropna(subset=['count_hugged_hr'])
            ...
            if not df_data.empty:
                ...
                correlation_results = df_data.groupby('30days_unit').apply(spearman_corr_p, 'count_hugged_hr').reset_index()
